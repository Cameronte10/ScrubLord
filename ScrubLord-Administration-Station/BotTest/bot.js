...
client.on('message', async msg =>
{
    ...
    if (msg.content === prefix+"help") 
    {
        ...
        {
            name: prefix + "meow",
            value: "Sends an image of a cat right into the chat"
        },
        {
            name: prefix + "egg",
            value: "Can I offer you an egg in this trying time?"
        },
        {
...
client.login('NTM3NTAyNjA3MTQ5NzYwNTMz.DymMEw.YMIYeblZWuzykgS1MAAW9rzO6iA'/*'NTI0NzI4MjM0NTU4ODgxNzky.DvsTPQ.b2mUR9d3RCCnSbDAxds8MaX0Ih8'*//*TestBot*/);
